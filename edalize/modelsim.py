...
run: work $(VPI_MODULES)
	$(VSIM) -do error_catch_run.tcl -c $(addprefix -pli ,$(VPI_MODULES)) $(EXTRA_OPTIONS) $(TOPLEVEL)
...
ERROR_HANDLER ="""#Generated by Edalize
set breakerror 0
onbreak {
  set breakerror 1
  resume
...
class Modelsim(Edatool):
    ...
    def _write_errorhandler(self):
        eh = open(os.path.join(self.work_root, "error_catch_run.tcl"), 'w')
        eh.write(ERROR_HANLDER)
        eh.close()
